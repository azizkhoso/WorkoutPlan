...
public class Graph_Shortest_Path { 
    ...
    int getMinpath(int path_array[], int vert) {
    	return path_array[vert];
    }
    
// Implementation of Dijkstra's algorithm for graph (adjacency matrix) 
    int algo_dijkstra(int graph[][], int src_node, int vert)  { 
   ...
   // now find shortest path for all vertices  
        ...
        return getMinpath(path_array, vert);
    } 
}
/*public class Main{
    ...
    { 
        ...
        System.out.println(g.algo_dijkstra(graph, 2, 4)); 
    } 
}*/